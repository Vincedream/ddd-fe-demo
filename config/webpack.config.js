  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        '@domain': paths.appSrc + '/common/domains',
        '@data-source': paths.appSrc + '/common/data-source',
        '@components': paths.appSrc + '/common/components',
        '@constants': paths.appSrc + '/common/constants',
      },
      plugins: [
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin(
        Object.assign(
          ...
          {
            inject: true,
            template: paths.appPublic + '/lottery.html',
            chunks: ["lottery"],
      ...
      new HtmlWebpackPlugin(
        Object.assign(
          ...
          {
            inject: true,
            template: paths.appPublic + '/user.html',
            chunks: ["user"],
            filename: "user.html"
          },
          isEnvProduction
